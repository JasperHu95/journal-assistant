...
const zh: Translations = {
  ...
  "nav.dashboard": "仪表盘",
  "nav.builtin_rss": "内置RSS源",
  "nav.feeds": "RSS 订阅源",
  "nav.journals": "期刊",
  "nav.journals.expand": "展开期刊列表",
  "nav.tags": "标签",
  ...
  "feeds.refresh_all": "一键刷新",
  "feeds.refresh_all_progress": "刷新中 {current}/{total}...",
  "feeds.auto_refresh": "自动刷新",
  ...
  "articles.add_tag": "添加标签",
  "articles.tag_exists_confirm": "已存在标签 '{name}'（大小写不同），是否合并？",
  "journals.title": "期刊",
...
const en: Translations = {
  ...
  "nav.builtin_rss": "Built-in RSS",
  "nav.feeds": "RSS Feeds",
  "nav.journals": "Journals",
  "nav.journals.expand": "Expand journal list",
  "nav.tags": "Tags",
  ...
  "feeds.refresh_all": "Refresh All",
  "feeds.refresh_all_progress": "Refreshing {current}/{total}...",
  "feeds.auto_refresh": "Auto Refresh",
  ...
  "articles.add_tag": "Add Tag",
  "articles.tag_exists_confirm": "Tag '{name}' already exists (different case). Merge?",
  "journals.title": "Journals",
  "journals.select": "Select a journal",
  "journals.articles_count": "articles",
  "journals.unread": "unread",
